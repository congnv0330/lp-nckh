  ...
  <div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 my-6">
      <div class="bg-white shadow-md p-5">
        ...
        <textarea v-model="input.matrix" title="Ma trận" placeholder="Ma trận ..." id="matriX" class="block appearance-none border border-gray-400 rounded w-full text-gray-700 py-2 px-3 focus:outline-none focus:border-blue-500 focus:shadow mb-4" rows="4"></textarea>
        <div class="flex mb-4">
        ...
        <div class="text-center md:text-left" v-if = "!isHidden">
          <button @click="submitD2" id="btnCalc2" class="bg-blue-500 text-white hover:bg-blue-700 focus:outline-none focus:shadow-outline rounded px-5 py-2 mr-2">
            Thực hiện
          </button>
          <button @click="isHidden = true" class="bg-green-500 text-white hover:bg-green-600 focus:outline-none rounded px-4 py-2 mr-2">
            Dạng 1
          </button>
          <button @click="reset" id="btnDel2" class="bg-gray-500 text-white hover:bg-gray-600 focus:outline-none rounded px-4 py-2">
            Xóa
          </button>
        </div>
        <div class="text-center md:text-left" v-if = "isHidden">
          <button @click="submitD1" id="btnCalc1" class="bg-blue-500 text-white hover:bg-blue-700 focus:outline-none focus:shadow-outline rounded px-5 py-2 mr-2">
            Thực hiện
          </button>
          <button @click="isHidden = false" class="bg-green-500 text-white hover:bg-green-600 focus:outline-none rounded px-4 py-2 mr-2">
            Dạng 2
          </button>
          <button @click="reset" id="btnDel1" class="bg-gray-500 text-white hover:bg-gray-600 focus:outline-none rounded px-4 py-2">
            Xóa
          </button>
        </div>
      </div>
